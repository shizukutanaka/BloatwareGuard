...
|| 35. Misc bloat services → demand-start (WAP push/MDM, Maps broker, media sharing, diagnostics hub, Nearby Sharing, NVIDIA/Intel telemetry) | ✅ | ✅ | HKLM needs admin |
...
```bash
python bloatware_guard.py --version   # BloatwareGuard v1.25.0-mvp
BloatwareGuard.exe --version          # BloatwareGuard v1.25.0-mvp
```
