...
REM Already in C:\Users\HP\bloatware-guard\verify_scan_sys.ps1
copy /Y C:\Users\HP\bloatware-guard\verify_scan_sys.ps1 C:\temp\verify_scan_sys.ps1

echo [4/4] Registering SYSTEM Scheduled Task (runs at next boot) ...
schtasks /delete /tn "BloatwareGuardVerify" /f 2>nul
schtasks /create /tn "BloatwareGuardVerify" /tr "powershell.exe -ExecutionPolicy Bypass -File C:\temp\verify_scan_sys.ps1" /sc once /st 03:00 /ru SYSTEM /rl HIGHEST 2>&1
